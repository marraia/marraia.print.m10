...
exports.ImprimePedido = function (params, success, error){
    exec(success, error, 'MainActivity', 'ImprimePedido', [params]);
}

exports.ImprimePedidoConsolidado = function (params, success, error){
    exec(success, error, 'MainActivity', 'ImprimePedidoConsolidado', [params]);
}
